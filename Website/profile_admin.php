...
<body>
    ...
    <main style="font-size:25px" ;>
        <div class="shadow p-3 mb-5 bg-white rounded" style="margin: 100px; margin-bottom: 100px; padding: 10px;">
            <h1 style="margin: 40px 100px 0px 100px; text-align: center; font-weight: bold;  ">Admin</h1>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8 " style="text-align: center;">
                        <div class="info"
                            ...
                            <pre><h2>NAME           :       <?php echo $_SESSION['admin_name'] ?></h2>
            ...
            <div class="shadow p-3 mb-5 bg-white rounded" style="margin: 100px; ">
                <div class="row">
                    <div class="col-sm-4">
                        <div class="media">
                            <img class="mr-1 rounded-circle" src="img/newregister.png" alt="Generic placeholder image"
                                style="max-width:230px ; margin-left: 100px; margin-top: 10px; display: inline-flex; ">
                        </div>
                    </div>
                    <div class="col-sm-8 " style="text-align: center;">
                        <div class="info" style="text-align: left;  padding-top: 10px;">
                            <h2 style="font-size : 40px; padding : 30px; padding-bottom:40px; text-align: center">New
                                Voter Registration</h2><br>
            ...
            <div class="shadow p-3 mb-5 bg-white rounded" style="margin: 100px; padding: 30px;">
                <div class="row">
                    <div class="col-sm-4">
                        <div class="media">
                            <img class="mr-3 rounded-circle" src="image/KARNATAK.jpg" alt="Generic placeholder image"
                                style="max-width:200px ; margin-left: 100px; margin-top: 30px; display: inline-flex; background-color: rgb(241, 246, 250);">
                        </div>
                    </div>
                    <div class="col-sm-8 " style="text-align: center;">
                        <div class="info" style="text-align: left;  padding-top: 10px;">
                            <h2 style="font-size: 50px;">Karnataka Assembly election, 2023
                            </h2><br>
                            <h3 style="padding-bottom: 20px;font-size: 20px;">DATE - 10 MAY 2023</h3>
                            <div class="form-group">
                                <div class="container">
            ...
            <div class="shadow p-3 mb-5 bg-white rounded" style="margin: 100px; padding: 30px;">
                <div class="row">
                    <div class="col-sm-4">
                        <div class="media">
                            <img class="mr-3 rounded-circle" src="image/ap.jpg" alt="Generic placeholder image"
                                style="max-width:200px ; margin-left: 100px; margin-top: 30px; display: inline-flex; background-color: rgb(241, 246, 250);">
                        </div>
                    </div>
                    <div class="col-sm-8 " style="text-align: center;">
                        <div class="info" style="text-align: left;  padding-top: 10px;">
                            <h2 style="font-size: 50px;">ANDHRA PRADESH STATE ELECTION 2024</h2><br>
                            <h3 style="padding-bottom: 20px;font-size: 20px;">DATE - 15 JUNE 2023</h3>
                            <div class="form-group">
                                <div class="container">
                                    <a href="http://localhost:3000/">
                                        <button class="btn btn-success btn-lg float-right" style="width: 600px;"
